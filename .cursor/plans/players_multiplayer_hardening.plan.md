...
- **Remove** debounced [`apiPatchSpaceCamera`](vigil/src/components/foundation/architectural-neon-api.ts) from [`ArchitecturalCanvasApp.tsx`](vigil/src/components/foundation/ArchitecturalCanvasApp.tsx) (~2957).
