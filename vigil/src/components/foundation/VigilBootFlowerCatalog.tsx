  ...
  return (
    <div className={styles.root}>
      ...
      <p className={styles.intro}>
        ...
        rainbow) each have a <strong>{Math.round(VIGIL_BOOT_FLOWER_RARE_SPAWN_EACH * 100)}%</strong> spawn rate in
        the live garden; all other varieties split the remainder evenly.
      </p>
