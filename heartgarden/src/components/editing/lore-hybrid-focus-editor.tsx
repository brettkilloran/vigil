...
export function LoreHybridFocusEditor({
  ...
  useEffect(() => {
    // biome-ignore lint/complexity/noExcessiveCognitiveComplexity: variant fan-out (character/location/faction) parses each focus-document HTML shape and reconciles parts vs notes resync
    startTransition(() => {
