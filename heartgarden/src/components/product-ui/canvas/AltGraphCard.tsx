...
export const AltGraphCard = forwardRef<HTMLDivElement, AltGraphCardProps>(
  function AltGraphCard(
    {
      open,
      term,
      x,
    ...
    return (
      ...
      >
        ...
        <div className="mb-2 rounded border border-[var(--vigil-border)] bg-[var(--vigil-canvas)]/70 p-1">
          <svg className="h-[150px] w-full" viewBox="0 0 960 500">
              ...
              return (
                <g key={node.id}>
                  <circle
                    ...
                    strokeDasharray={
                      node.ghost && !isCenter ? "6 4" : undefined
                    }
        ...
        <div className="mb-1 flex items-center justify-between text-[var(--vigil-muted)] text-xs">
          ...
          <span>
            {loadingSearch
              ? "Searching..."
              : `${searchItems.length} search hits`}
          </span>
        </div>
