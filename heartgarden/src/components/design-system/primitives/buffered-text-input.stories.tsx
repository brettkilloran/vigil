  ...
  render: () => {
    ...
    return (
      <div className="w-[min(100vw-32px,360px)] space-y-2">
        {/* biome-ignore lint/a11y/noLabelWithoutControl: the label wraps a BufferedTextInput component which renders a real `<input>` internally; static analysis cannot see through the component boundary. */}
