...
} from "@/src/components/editing/buffered-content-editable";
...
// biome-ignore lint/complexity/noExcessiveCognitiveComplexity: canvas node card composes drag/select/expand state and tape variant rendering
          ...
          >
            ...
            >
              {imageCardMedia.src ? (
                ...
                // biome-ignore lint/correctness/useImageSize: dynamic dimensions; intrinsic size not known at render time
                <img
    ...
    >
      ...
      {factionRosterRows ? (
        ...
        >
          ...
          <ul className={styles.factionRosterCanvasList}>
