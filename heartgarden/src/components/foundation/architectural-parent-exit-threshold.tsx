...
export interface ArchitecturalParentExitThresholdProps {
 ...
 */
export const ArchitecturalParentExitThreshold =
  function ArchitecturalParentExitThreshold({
    ...
    return (
      <div className={`${styles.rail} ${visible ? styles.railVisible : ""}`}>
        {/* biome-ignore lint/a11y/useAriaPropsSupportedByRole: role is always button or region, both support aria-label; static analysis cannot resolve the ternary */}
        <div
          aria-label={
            interactive
