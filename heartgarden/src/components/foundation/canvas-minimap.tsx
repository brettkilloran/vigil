...
export function CanvasMinimap({
  ...
  return (
    ...
    >
      {/* biome-ignore lint/a11y/useKeyWithClickEvents: spatial pointer-driven minimap; clicking maps a screen point to a world coordinate. There is no meaningful keyboard equivalent — keyboard pan/zoom is exposed via the global Cmd+arrow shortcuts in the canvas shell. */}
      <svg
