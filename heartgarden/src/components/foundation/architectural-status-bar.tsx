...
// biome-ignore lint/complexity/noExcessiveCognitiveComplexity: status bar popover renders sync/save/version variants across env, session, and offline states
function SaveAndVersionPopover({
  ...
  const {
    ...
    relSaved,
    absSaved,
    // biome-ignore lint/complexity/noExcessiveCognitiveComplexity: derives status copy/severity/pulse tone from sync state machine across loading/local/saving/saved/error
  } = useMemo(() => {
